...
/**
 * REST controller for managing {@link io.microservices.demo.referencemanagement.domain.PaperCollection}.
 */
@RestController
@RequestMapping("/api")
public class PaperCollectionResource {
    ...
    private static final String ENTITY_NAME = "paperCollection";
